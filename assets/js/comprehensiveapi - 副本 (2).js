			...
			[ //标题栏
				{
					...
					title: '盘次'
										...
										templet: function(d) {
											if (d.state == 0) {
												lastItemPB = d;
												return '<span> ' + d.ysb_1.toFixed(2) + ' </span>'
											}
											var html = '<span style="color: ' + xfsetColor(d.pbh,'油石比', 0, 0,lastItemPB.ysb_1.toFixed(2), d.ysb.toFixed(2)) +
												';"> ' + d.ysb_1.toFixed(2) + ' </span>';
												xfsetColor(d.pbh,'混合料出料', 0, 0,lastItemPB.outTemp.toFixed(2), d.outTemp.toFixed(2));
											return html;
										},
									}
									//, {
									...
									//		if (d.state == 0) {
									//			lastItemPB = d;
									//			return '<span> ' + d.outTemp.toFixed(2) + ' </span>'
									//		}
									//		var html = '<span style="color: ' + xfsetColor(d.pbh,'混合料出料', 0, 0,lastItemPB.outTemp.toFixed(2), d.outTemp.toFixed(2)) +
									//			';"> ' + d.outTemp.toFixed(2) + ' </span>';
									//		return html;
									//	},
									//}
			]
