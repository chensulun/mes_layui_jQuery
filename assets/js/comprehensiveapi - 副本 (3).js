...
function renqiushenji(layui, data) {
	...
	var model={
 	guanci:"配比单",
 	one_S_P:list1.one_S_P,
    two_S_P:list1.two_S_P,
	three_S_P:list1.three_S_P,
    four_S_P:list1.four_S_P,
	five_S_P:list1.five_S_P,
 	six_S_P:list1.six_S_P,
	seven_S_P:list1.seven_S_P,
 	six_1_S:list1.six_1_S,
 	zshsl:list1.zshsl,
 	eight_1_S_P:list1.eight_1_S_P
	}
	var list=[];
	list.push(model);
	list.push(list1);
			...
			[ //标题栏
				{
					...
					templet: function(d) {
						...
						var html = '<span style="color: ' + xfsetColor(d.pbh,'仓1', 0, 0, lastItemPB.one, d.one_S) + ';"> ' + d.one_S +
							' </span>';
						return html;
					},
					width: 80
					...
					templet: function(d) {
						...
						var html = '<span style="color: ' + xfsetColor(d.pbh,'仓2', 0, 0, lastItemPB.two, d.two_S) + ';"> ' + d.two_S +
							' </span>';
						return html;
					},
					width: 80
					...
					templet: function(d) {
						...
						var html = '<span style="color: ' + xfsetColor(d.pbh,'仓3', 0, 0, lastItemPB.three, d.three_S) + ';"> ' + d.three_S +
							' </span>';
						return html;
					},
					width: 120
					...
					templet: function(d) {
						...
						var html = '<span style="color: ' + xfsetColor(d.pbh,'仓4', 0, 0, lastItemPB.four, d.four_S) + ';"> ' + d.four_S +
							' </span>';
						return html;
					},
					width: 80
					...
					templet: function(d) {
						...
						var html = '<span style="color: ' + xfsetColor(d.pbh,'仓6', 0, 0, lastItemPB.six_1, d.six_S) + ';"> ' + d.six_S +
							' </span>';
						return html;
					},
					width: 80
					...
					templet: function(d) {
						...
						var html = '<span style="color: ' + xfsetColor(d.pbh,'新粉1', 0, 0, lastItemPB.six, d.seven_S) + ';"> ' + d.seven_S +
							' </span>';
						return html;
					},
					width: 80
					...
					templet: function(d) {
						...
						var html = '<span style="color: ' + xfsetColor(d.pbh,'新粉2', 0, 0, lastItemPB.seven, d.six_1_S) + ';"> ' + d.six_1_S +
							' </span>';
						return html;
					},
					width: 80
					...
					templet: function(d) {
						if (d.state == 0) {
							lastItemPB = d;
							return '<span> ' + d.zshsl + ' </span>'
						}
						var html = '<span style="color: ' + xfsetColor(d.pbh,'回收料', lastItemPB.zshsl, d.zshsl, 0, 0) +
							';"> ' + d.zshsl + ' </span>';
						return html;
					},
					width: 80
					...
					templet: function(d) {
						...
						var html = '<span style="color: ' + xfsetColor(d.pbh,'沥青', 0, 0, lastItemPB.eight, d.eight) +
							';"> ' + d.eight + ' </span>';
						return html;
					},
					width: 80
			...
			[ //标题栏
				{
					...
					templet: function(d) {
						...
						var html = '<span style="color: ' + xfsetColor(d.pbh,'仓5', 0, 0, lastItemPB.five_S, d.five_S) + ';"> ' + d.five_S_P +
							' </span>';
						return html;
					},
					width: 80
					...
					templet: function(d) {
						...
						var html = '<span style="color: ' + xfsetColor(d.pbh,'仓6', 0, 0, lastItemPB.six_1_S, d.six_1_S) + ';"> ' + d.six_1_S +
							' </span>';
						return html;
					},
					width: 80
					...
					templet: function(d) {
						...
						var html = '<span style="color: ' + xfsetColor(d.pbh,'新粉1', 0, 0, lastItemPB.six_S, d.six_S) + ';"> ' + d.six_S_P +
							' </span>';
						return html;
					},
					width: 80
					...
					templet: function(d) {
						...
						var html = '<span style="color: ' + xfsetColor(d.pbh,'新粉2', 0, 0, lastItemPB.seven_S, d.seven_S) + ';"> ' + d.seven_S_P +
							' </span>';
						return html;
					},
					width: 80
			...
			[ //标题栏
				...
				}, 
				{
					...
					templet: function(d) {
						...
						var html = '<span style="color: ' + xfsetColor(d.pbh,'回收料', 0, 0, lastItemPB.zshsl, d.zshsl) +
							';"> ' + d.zshsl + ' </span>';
						return html;
					},
					width: 80
...
function xfsetColor(hhl_type,fileName, setVal, val, setVal1, val1) {
					...
					$.each(gz, function(i, item) {
						if (item.setting_name == fileName && item.hhl_type==hhl_type && item.yccd=="一般") {
